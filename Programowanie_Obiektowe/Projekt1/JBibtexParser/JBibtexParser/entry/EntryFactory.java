package JBibtexParser.entry;

import JBibtexParser.entry.entries.CommentEntry;
import JBibtexParser.entry.entries.PreambleEntry;
import JBibtexParser.entry.entries.PublicationEntry;
import JBibtexParser.entry.entries.StringEntry;
import JBibtexParser.fieldparser.IFieldParser;
import JBibtexParser.typemanager.IEntryTypesManager;
import JBibtexParser.util.LeveledString;
import JBibtexParser.util.exceptions.FieldOrTypeMissingException;
...
public class EntryFactory {
     ...
     * @param stringEntries - a list of string entries provided by {@link JBibtexParser.Parser}, to which EntryFactory adds newly created entries, also used for text substitution by {@link IFieldParser}
     * @param commentEntries - a list of comment entries provided by {@link JBibtexParser.Parser}, to which EntryFactory adds newly created entries
     * @param entryTypesManager - a manager used to recognise types and fields. Usually a {@link JBibtexParser.typemanager.DynamicTypesManager}, but {@link JBibtexParser.typemanager.StaticTypesManager} is also provided.
     * @param fieldParser - A parser of a single key-value pair, {@link IFieldParser} can be implemented for adding custom behaviour. {@link JBibtexParser.fieldparser.SimpleFieldParser} currently provides sample splitting of multiple authors
     */
    ...
    /**
     * Creates an entry from a block of text containing only one entry from {@link JBibtexParser.reader.IBlocksProvider}, for example reading from a file can use {@link JBibtexParser.reader.FileReader}
