...
public class EntryFactoryTest {
    ...
    public EntryFactory getMockedFactory() {
        ...
        IFieldParser mockFieldParser = new IFieldParser() {
            @Override
        ...
        EntryFactory entryFactory = new EntryFactory(new LinkedList<StringEntry>(), new LinkedList<CommentEntry>(),mockEntryManager,mockFieldParser);
        return entryFactory;
    }
}
